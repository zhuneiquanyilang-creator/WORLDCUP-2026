...
// QF→SF の接続は FIFA 規定で m101=W97+W98 / m102=W99+W100。
// したがって QF 列は [97, 98, 99, 100] の順に並べ、そのペアリング
// (97,98)→m101 / (99,100)→m102 が線とカード内容で一致するようにする。
// R16/R32 も同じ半 (upper / lower) 内で連続するよう並び替え。
const R32_ORDER = [74, 77, 73, 75, 76, 78, 79, 80, 83, 84, 81, 82, 86, 87, 85, 88];
const R16_ORDER = [90, 89, 91, 92, 93, 94, 95, 96];
